...
cc -c -w -O2 -I "$TS/odin" "$TS/odin/parser.c" -o "$TS/parser.o"
cc -c -w -O2 -I "$TS/odin" "$TS/odin/scanner.c" -o "$TS/scanner.o"
ar rcs "$TS/libtreesitter.a" "$TS/runtime.o" "$TS/parser.o" "$TS/scanner.o"
