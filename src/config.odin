...
COLOR_CONFLICT_OURS := tb2.Color(0x73c936)
COLOR_CONFLICT_THEIRS := tb2.Color(0x2d93ec)
COLOR_CONFLICT_BASE := tb2.Color(0x868686)

CURRENT_LINE_TINT: f32 = 0.06
AI_EDIT_TINT: f32 = 0.35
GIT_HUNK_TINT: f32 = 0.12
GIT_DIFF_GHOST_TINT: f32 = 0.12
GIT_DIFF_WORD_TINT: f32 = 0.34
CONFLICT_TINT: f32 = 0.14
CONFLICT_MARKER_TINT: f32 = 0.32
CONFLICT_WORD_TINT: f32 = 0.34
