...
commands := [?]Command {
	...
	{name = "Terminal: Toggle", shortcut = "Alt+t", alt_ch = 't', run = term_toggle},
	...
	{name = "Switch Buffer", shortcut = "Alt+e", alt_ch = 'e', run = bufswitch_open},
	...
	{name = "LSP: Go to Definition", shortcut = "Alt+d", alt_ch = 'd', run = cmd_lsp_definition},
	{name = "LSP: Hover", shortcut = "Alt+s", alt_ch = 's', run = cmd_lsp_hover},
	{name = "LSP: Rename Symbol", shortcut = "Alt+r", alt_ch = 'r', run = cmd_lsp_rename},
	...
	{name = "Git: Toggle Diff View", shortcut = "Alt+g", alt_ch = 'g', run = cmd_toggle_diff_view},
	{name = "Git: Resolve Conflict", shortcut = "Alt+m", alt_ch = 'm', run = cmd_merge_resolve},
	{name = "Toggle Line Wrap", run = cmd_toggle_line_wrap},
	{name = "LSP: Next Diagnostic", shortcut = "Alt+>", alt_ch = '>', run = cmd_diag_next},
	{name = "LSP: Previous Diagnostic", shortcut = "Alt+<", alt_ch = '<', run = cmd_diag_prev},
